                                ...
                                if($row['replied'] == '1') {
                                    ...
                                    echo "<td>
                                            <div class='input-group mb-2'>
                                                <input type='text' class='form-control' placeholder='Answer' id='".$row['enroll'].":::".$row['updated']."edit' aria-describedby='button-addon2'>
                                                <button class='btn btn-primary' type='button' id='".$row['enroll'].":::".$row['updated']."' onclick='submitAnswer(this.id)'>Submit</button>
                                            </div>
                                        </td>";
                                }
                                echo   "<td class='".$row['enroll']."'>".$row['updated']."</td>";
                            }
                        ?>
                        <tr>
                    </table>
