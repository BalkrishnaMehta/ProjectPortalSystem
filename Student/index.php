                ...
                <div class="w-100 d-flex justify-content-center p-5">
                    <table class="table w-50">
                        ...
                        <tr>
                            ...
                            <td><?php if(isset($index)) echo ($groupsData[$index]['projectName'] != "")?$groupsData[$index]['projectName']:"Not Entered"; else echo "Not Entered" ;?></td>
                        </tr>
                        <tr>
                            <th>Guide Name</th>
                            <td><?php if(isset($index)) echo $groupsData[$index]['guidename']; else echo "Not Allocated" ;?></td>
                        </tr>
                        <tr>
            ...
            <div class="tab-pane fade" id="addProjectDetails" role="tabpanel" aria-labelledby="addProjectDetails-tab">
                <div class="w-100 d-flex justify-content-center p-5">
                    ...
                    <table class="table w-50">
                        <tr>
                            <th><label for="projectName" class="form-label">Project Name</label></th>
                            <td><input class="form-control" type="text" id="projectName" name="projectName" required value="<?php if(isset($index)) echo $groupsData[$index]['projectName']?>" <?php if(isset($index)) if($groupsData[$index]['projectName'] != ""){ echo "disabled";}?>></td>
                        </tr>
                        <tr>
