                ...
                <div class="w-100 d-flex justify-content-center p-5">
                    <?php
                     if(isset($_REQUEST['createGroup'])) {
                        ...
                        $conn -> query('INSERT INTO groups values("'.$group.'", "'.$_REQUEST['guide'][0].'", "'.$_REQUEST['guide'][1].'", "", "'.$_REQUEST['batch'].'")');
                        $conn -> query('CREATE TABLE IF NOT EXISTS '.$group.'(enroll varchar(100) PRIMARY KEY, name varchar(100), marks int)');
                        for($i = 0;$i < 5; $i++) {
                    ...
                    <table class="table table-bordered w-100">
                        ...
                        <tr>
                            <th class='rowspan text-center'>
                                <input type='text' class='form-control' name='groupID' placeholder='Group ID' required><hr>
                                <input type='text' class='form-control' name='batch' placeholder="Batch (ex: <?php echo date("Y");?>)" required>
                            </th>
                            <td>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="student[0][enroll]" required   onchange="changeName(this)">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="student[1][enroll]" required onchange="changeName(this)">
                                                <option value=''>Student Enrollment Number</option>
                                                <?php
                                                    for ($i=0;$i<count($students);$i++){
                                                        $value = $students[$i]['enrollmentNo'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="student[2][enroll]" required onchange="changeName(this)">
                                                <option value=''>Student Enrollment Number</option>
                                                <?php
                                                    for ($i=0;$i<count($students);$i++){
                                                        $value = $students[$i]['enrollmentNo'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="student[3][enroll]" required onchange="changeName(this)">
                                                <option value=''>Student Enrollment Number</option>
                                                <?php
                                                    for ($i=0;$i<count($students);$i++){
                                                        $value = $students[$i]['enrollmentNo'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="student[4][enroll]" required onchange="changeName(this)">
                                                <option value=''>Student Enrollment Number</option>
                                                <?php
                                                    for ($i=0;$i<count($students);$i++){
                                                        $value = $students[$i]['enrollmentNo'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select" name="guide[]" required onchange="changeGuideName(this)">
